...
@Component({
  selector: 'app-admin-people-picker',
  templateUrl: './admin-people-picker.component.html',
  styleUrls: ['./admin-people-picker.component.scss']
})
export class AdminPeoplePickerComponent implements OnInit,OnChanges, AfterViewInit {
